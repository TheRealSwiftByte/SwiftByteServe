                            ...
                            alignSelf: "stretch"}
                                ...
                                <View style={styles.div}>
                                    ...
                                    <View style={styles.author}>
                                        <Text 
                                            style={{fontWeight: "100", marginLeft: 8, marginBottom: 4, fontSize: 12, color: "8E8E93"}}
                                        >20/12/2020</Text>
                                        <Text
                                            style={{fontWeight: "500", marginLeft: 8, fontSize: 14}}
                                        >Awesome and Nice</Text>
                                        ...
                                        <Text
                                            style={{fontWeight: "100", marginLeft: 8, color: "8E8E93", fontSize: 12}}
                        ...
                        <View style={styles.userRow}>
                            ...
                            alignSelf: "stretch"}
                                ...
                                <View style={styles.div}>
                                    ...
                                    <View style={styles.author}>
                                        <Text 
                                            style={{fontWeight: "100", marginLeft: 8, marginBottom: 4, color: "8E8E93", fontSize: 12}}
                                        >20/12/2020</Text>
                                        <Text
                                            style={{fontWeight: "500", marginLeft: 8, fontSize: 14}}
